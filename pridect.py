...
def pridect(imagePath, modelPath):
    ...
    image.show()
    # 3. 加载模型
    model = torch.load(modelPath, weights_only=False,map_location="cpu")
...
if __name__ == '__main__':
    pridect("C:/Users/yang/Downloads/weather_photos/cloudy/cloudy295.jpg","./model/weather-2022-10-14-07-36-57.pth")
